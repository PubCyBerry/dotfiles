...
artifact_allowed() {
    ...
    case "$path" in
        ...
        "$HOME/.codex/AGENTS.md"|"$HOME/.codex/config.toml"|"$HOME/.codex/hooks.json"|"$HOME/.claude/CLAUDE.md"|"$HOME/.claude/settings.json"|"$HOME/.claude/statusline.sh"|"$HOME/.claude/claude-hud.json"|"$HOME/.gemini/config/GEMINI.md"|"$HOME/.gemini/GEMINI.md"|"$HOME/.gemini/config/hooks.json") return 0 ;;
